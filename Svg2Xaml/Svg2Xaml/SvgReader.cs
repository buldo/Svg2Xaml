...
namespace Svg2Xaml
{
    ...
    public static class SvgReader
    {
        ...
        /// </returns>
        /// <exception cref="XmlException">Root element is not an svg element.</exception>
        /// <exception cref="XmlException">Root element is not in namespace 'http://www.w3.org/2000/svg'</exception>
